...
export function AboutHeader() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://images.pexels.com/photos/6646918/pexels-photo-6646918.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750')",
      ...
      <div className="container mx-auto px-4 h-full flex items-center">
        ...
        >
          <div className="flex items-center mb-6">
            <Heart className="text-[#ffc107] mr-3 animate-pulse" />
            <h2 className="text-rose-200 font-medium tracking-wider uppercase text-sm md:text-base">
              Our Purpose & Passion
            </h2>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Making a <span className="text-[#ffc107]">difference</span>,<br />{" "}
            one life at a time
          </h1>
          <p className="text-xl md:text-2xl text-gray-200 leading-relaxed mb-8 max-w-2xl">
            We're committed to creating lasting change through compassion,
            dedication, and community support.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link
              to="/donate"
              className="px-8 py-4 bg-[#FFC107] hover:bg-[#ffc107]/50 text-white rounded-full font-medium text-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Donate Now
            </Link>
            <Link
