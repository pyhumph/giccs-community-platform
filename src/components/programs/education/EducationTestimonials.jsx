                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="mt-16 text-center">
                        ...
                        <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                            Watch our student testimonial videos to hear directly from those
                            who have benefited from our education support program.
                        </p>
                        <button className="bg-[#FFC107] hover:bg-[#e0a800] text-[#1E1E20] font-bold py-3 px-8 rounded-full transition duration-300">
                            Watch Videos
                        </button>
                    </div>
                </div>
